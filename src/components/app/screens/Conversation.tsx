...
export function Chat() {
  const messages = [
    { from: "them", text: "Assalamu alaikum. Thank you for accepting the introduction." },
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-3 border-b border-line px-6 pb-3 pt-2">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <span className="text-[15px] font-semibold text-ink">Brother · 29</span>
          <span className="text-[11px] text-body">Toronto · Introduced Tuesday</span>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col gap-3 px-5 py-4">
        <p className="mx-auto max-w-[280px] rounded-md bg-line/40 px-3 py-2 text-center text-[11px] leading-[15px] text-body">
          ...
          <div
            ...
            className={`max-w-[78%] rounded-lg px-3.5 py-2.5 text-[13px] leading-[19px] ${
              m.from === "me"
                ...
                : "self-start rounded-bl-sm border border-line bg-white text-ink"
            }`}
          >
            {m.text}
          </div>
        ...
        <p className="mx-auto max-w-[290px] text-center text-[10px] leading-[14px] text-body/60">
          Contact details are exchanged at the final step, not here.
        </p>
      </div>

      <div className="border-t border-line bg-white px-5 pb-8 pt-3">
        <div className="flex items-center gap-2.5">
          <span className="flex h-11 flex-1 items-center rounded-pill border border-line px-4 text-[13px] text-body/45">
            Write a message…
          </span>
          <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-brass text-ink">
            <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M13 6l6 6-6 6" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
        </div>
        <p className="mt-2 text-center text-[10px] text-body/60">
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 flex-col gap-4 overflow-hidden px-6">
        <div className="flex flex-col gap-3 rounded-md border border-brass/40 bg-brass-tint/50 p-4">
          <div className="flex items-center justify-between">
            <span className="text-[12px] font-semibold uppercase tracking-[0.6px] text-brass">
              Awaiting your approval
            </span>
            <Chip tone="brass">1</Chip>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1">
              ...
              <span className="text-[11px] leading-[15px] text-body">
          ...
          <span className="text-[10px] leading-[14px] text-body/70">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="flex items-center gap-3 rounded-md border border-line bg-white p-3.5">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-0.5">
              <span className="text-[13px] font-semibold text-ink">Brother · 33 · Montreal</span>
              <span className="truncate text-[11px] text-body">
                14 messages · last Thursday
              </span>
            </div>
            <span className="rounded-pill border border-line px-3 py-1.5 text-[11px] font-semibold text-ink">
              Read
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          {[
            ...
            ["Fatima expressed interest", "Tuesday, 14:02"],
            ["Introduction sent to you both", "Tuesday, 09:00"],
          ].map(([what, when]) => (
            <div key={what} className="flex items-center gap-2.5 border-b border-line pb-2">
              <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-sage/20 text-sage">
                <Check className="h-3 w-3" />
              </span>
              <span className="flex-1 text-[12px] text-ink/80">{what}</span>
              <span className="text-[10px] text-body/60">{when}</span>
            </div>
          ))}
        </div>
      </div>
